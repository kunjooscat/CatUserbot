...
SLAP_TEMPLATES = [
    "{user1} {victim}ന്റെ തലയിൽ കൂടെ ജെസിബി കയറ്റിയിറക്കി 😪😪 .", 
    "{user1} {victim}ന്റെ തലക്ക് കുത്തിപ്പിടിച്ചു മൂക്ക് കൊണ്ട് തറയിൽ ക്ഷ ണ്ണ ണ്ട ണ്ട്രാ മ്ര എന്നെഴുതിപ്പിച്ചു 🤭🤭😜.",
    "️{user1} {victim}നെ തല കീഴായി തൂക്കിയെടുത്തു റോട്ടിലൂടെ വലിച്ചിഴച്ചു 🤭🤭😜.",
    "{user1} ️{victim}നെ കാലേ വാരി നിലത്തടിച്ചു 🤓☹️",
    "️{user1} {victim}ന്റെ കണ്ണു ചൂഴ്ന്നെടുത്തു കാക്കയ്ക്കിട്ടു കൊടുത്തു 😱😱🤭 .",
    "{user1} കാന്താരി മുളക് അരച്ചെടുത്തു {victim}ന്റെ കണ്ണിൽ തേച്ചു 🤗🤗😝 .", 
    "️{user1} കാക്കയെ വിളിച്ചു വരുത്തി {victim}ന്റെ മുഖത്തു അപ്പിയിടീച്ചു 😝🤣 .",
    "{user1} {victim}നെ മുള്ളുമുരിക്കിൽ കെട്ടിയിട്ടു ചാട്ടയ്ക്കടിച്ചു 😂😜 .",
    "{user1} {victim}നെ കൊതുകിനെ കൊല്ലുന്ന പോലെ അടിച്ചു കൊന്നു 🤭😜.", 
    "️{user1} കോഴിക്കാഷ്ടം എടുത്ത് {victim}ന്റെ മുഖത്തു തേച്ചു 🤮🤭🤣.",
    "{user1} {victim}നെ എടുത്തോണ്ട് പോയി മുതലക്കുളത്തിലിട്ടു 🤣🤣😛.",
    "️{user1} {victim}ന്റെ തല വെട്ടിയെടുത്തു ഉപ്പിലിട്ടു 😂😂😛.",
    "{user1} {victim}നെ ഗ്രൂപ്പിലെ തൊന്തരവ് സഹിക്ക വയ്യാതെ ചാക്കിൽ കെട്ടി തോട്ടിലൊഴുക്കി 🤭🤭😜", 
    "{user1} {victim}ന്റെ തല മൊട്ടയടിച്ചു പുള്ളി കുത്തി കഴുതപ്പുറത്തു കയറ്റി പഞ്ചായത്തു ഗ്രൗണ്ടിലൂടെ നാല് റൗണ്ട് ഓട്ടിച്ചു 🤭🤭😜",
]
